...
import hashlib
import math
from dht_storage import StorageNode  # Importation du code de l'étape 3
...
class AdvancedNode(StorageNode):
    def __init__(self, env, node_id, bootstrap_node=None, simulator_nodes=None):
        ...
        self.long_links = {}  # Table de routage pour les liens longs
        self.finger_table = {}  # Pour le routage "Chord-like"
